...
<?php
    ...
    while ($registro = $datos->fetch_assoc()) 
    {
        ...
        echo "<td class='table-secondary'>
                  <form action='EliminarID.php' method='post'>
                      <input type='hidden' name='idContacto' value='".$registro["idContacto"]."'>
                      <input class='btn btn-primary' type='submit' name='eliminar_".$registro["idContacto"]."' value='Eliminar'>
                  </form>
              </td>";
...
<form action="formularioInsert.html" method="get">
